                        ...
                        <tbody>
                            <tr>
                                <td
                                    ...
                                    <a href="http://localhost"
                                        ...
                                        target="_blank"
                                        data-saferedirecturl="https://www.google.com/url?q=http://localhost&amp;source=gmail&amp;ust=1645623404866000&amp;usg=AOvVaw2n3noDql3nXdNcg0XM1rq_">
                            ...
                            <tr>
                                <td width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <table class="m_-6024282621713539609inner-body" align="center" width="570"
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        Please click the button below to {{ $subject }}.</p>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        "{{ $subject }}" button, copy and paste the
                                                                        URL
                                                                        below
                                                                        into your web browser: <span
                                                                            style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';word-break:break-all"><a
                                                                                ...
                                                                                target="_blank"
                                                                                data-saferedirecturl="https://www.google.com/url?q={{ $url }}">{{ $url }}</a></span>
                                                                    </p>
                            ...
                            <tr>
                                <td
                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                    <table class="m_-6024282621713539609footer" align="center" width="570"
                                        cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <p
                                                        ...
                                                        © 2022 E-SKCK Polresta Tangerang. All rights reserved.</p>
